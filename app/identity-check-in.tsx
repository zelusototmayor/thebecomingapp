...
const RESPONSE_OPTIONS: { id: Response; label: string; sub: string }[] = [
  { id: 'yes', label: 'Full Alignment', sub: 'Living my purpose' },
  { id: 'somewhat', label: 'Partial Alignment', sub: 'Growing toward it' },
  { id: 'no', label: 'Misalignment', sub: 'Lost my way today' },
];
...
export default function IdentityCheckInScreen() {
  ...
  const handleSave = () => {
    if (!response || !state.mainMission) return;
  ...
  if (!state.mainMission) {
    return (
      <SafeAreaView style={styles.container}>
        <View style={styles.centerContent}>
          <Text style={styles.errorText}>No future identity defined</Text>
        </View>
      </SafeAreaView>
    );
  }
    ...
    return (
      <SafeAreaView style={styles.container}>
        <Animated.View entering={ZoomIn.duration(500)} style={styles.successContent}>
          ...
          <Text style={styles.successTitle}>Identity Affirmed.</Text>
          <Text style={styles.successText}>
            Every moment of awareness brings you closer to who you are becoming.
          </Text>
        </Animated.View>
      </SafeAreaView>
    );
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <View style={styles.header}>
          <Text style={styles.headerTitle}>FUTURE IDENTITY</Text>
        ...
        >
          ...
          <View style={styles.goalSection}>
            <Text style={styles.goalLabel}>MY FUTURE SELF</Text>
            <Text style={styles.goalQuote}>"{state.mainMission}"</Text>
          </View>

          {/* Question */}
          <View style={styles.questionSection}>
            <Text style={styles.questionText}>
              Did your actions today align with who you are becoming overall?
            </Text>
          ...
          <View style={styles.reflectionSection}>
            <View style={styles.reflectionLabelRow}>
              ...
              <Text style={styles.reflectionLabel}>REFLECT ON YOUR JOURNEY</Text>
            </View>
            <TextInput
              style={styles.reflectionInput}
              value={reflection}
              onChangeText={setReflection}
              placeholder="How are you evolving toward your future self?"
